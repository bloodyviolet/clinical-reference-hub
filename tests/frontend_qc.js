...
assert(sw.includes("clinical-reference-v31-v2-pcdt-pagination"));
...
assert(html.includes('/manifest.json?v=31'));
...
assert(
  sw.includes('clinical-reference-v31-v2-pcdt-pagination')
);
